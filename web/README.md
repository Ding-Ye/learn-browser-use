...
Next.js 15 doc viewer for learn-browser-use. Static site that reads `../docs/{zh,en}/*.md` at build time and renders the 12-chapter curriculum side-by-side in two languages.
